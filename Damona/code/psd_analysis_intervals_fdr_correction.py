...
def plot_group_spectra_with_individual_plots(data, condition_map, freqs, cro, significance_results, all_p_values):
    ...
    for interval in sorted_intervals:
        ...
        ax.set_ylabel('Relative power change to baseline (%)')
        ...
        plt.savefig(f'group_spectra_interval_{interval}.png')
        plt.close(fig)
...
def plot_group_spectra_with_subplots_percondition(data, condition_map, freqs, cro):
        ...
        for condition in sorted_conditions:
            ...
            # Save the figure
            fig.savefig(f"tmp/{cro}_condition_{condition}.png", bbox_inches='tight')
